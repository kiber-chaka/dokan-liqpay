...
class WC_Gateway_Liqpay extends WC_Payment_Gateway
{
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields = array(
            ...
            'public_key' => array(
                'title' => __('Live API public_key', 'woocommerce'),
                'type' => 'text',
                'description' => '',
                'default' => '',
                'desc_tip' => true,
            ...
            'private_key' => array(
                'title' => __('Live API private_key', 'woocommerce'),
                'type' => 'text',
                'description' => '',
                'default' => '',
                'desc_tip' => true,
